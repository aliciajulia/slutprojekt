    ...
    <html>
        ...
        <body>
            <div id="wrapper">
                ...
                <div id="nav">
                    <ul>
                        <li ><a class="topLeft active" href="index.html">Homepage</a></li>
                ...
                <div id="content">
                    <div class="index_tre">
                        ...
                        echo '<form method="POST" action="doUpdate.php">
                            <input type="text" style="width:330px; height:270px;" rows='17' cols="40" name="content" value="'.$data["1"]["content"].'">
